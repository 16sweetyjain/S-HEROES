          ...
          <Card className='form'>
            ...
            <i class="material-icons icon" onClick={props.prevStep}>chevron_left</i>
              <FormControl className={classes.formControl}>
                <InputLabel id="demo-mutiple-chip-label">Mood</InputLabel>
                <Select
                ...
                >
                  {factors.map((name) => (
                    <MenuItem key={name} value={name} style={getStyles(name, props.mood, theme)}>
                      <Checkbox checked={props.mood.indexOf(name) > -1} />
